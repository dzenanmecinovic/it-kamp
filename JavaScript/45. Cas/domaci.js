...
function getRating(filmovi) {
  ...
  let avg = ispis.reduce((a, b) => a + b) / ispis.length;
  return `\nProsecna ocena filmova ciji je director Christopher Nolan je: ${avg}.`;
}
