...
// // 1.indexOf() metoda dozvoljava drui argument (pozicija odakle krece trazenje stringa)
...
// //         return recenica.indexOf(/skola/i);
// //     } else if(recenica.startsWith("Automobil") {
// //         return recenica.startsWith("Automobil")
// //     } else if(recenica.length % 2 === 0) {
// //         return recenica.search("kuca")
// //     }
// // }

function task(recenica) {
    if(recenica.includes("skola") !== -1) {
